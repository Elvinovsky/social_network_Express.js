...
export const checkInputName =  check('name', ).exists()
    .trim()
...
export const checkInputWebsiteUrl =  check('websiteUrl').exists()
...
export const checkInputDescription =  check('description').exists()
    .trim()
