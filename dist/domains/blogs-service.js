...
exports.blogsService = {
    ...
    updateBlogById(id, name, description, websiteUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            return blogs_db_repository_1.blogsRepository.updateBlogById(id, name, description, websiteUrl);
        });
    },
    BlogByIdDelete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return blogs_db_repository_1.blogsRepository.searchBlogByIdDelete(id);
        });
    }
};
