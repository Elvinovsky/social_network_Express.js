...
exports.blogsRouter.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const getAllBlogs = yield blogs_db_repository_1.blogsRepository.returnOfAllBlogs();
...
exports.blogsRouter.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const getByIdBlog = yield blogs_db_repository_1.blogsRepository.findBlogById(req.params.id);
    if (!getByIdBlog) {
        res.sendStatus(404);
        return;
    }
...
exports.blogsRouter.put('/:id', guard_authentication_1.guardAuthentication, check_bodyBlog_1.checkInputName, check_bodyBlog_1.checkInputWebsiteUrl, check_bodyBlog_1.checkInputDescription, check_for_errors_1.checkForErrors, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const foundBlogForUpdate = yield blogs_db_repository_1.blogsRepository
...
exports.blogsRouter.delete('/:id', guard_authentication_1.guardAuthentication, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const foundBlogDelete = yield blogs_db_repository_1.blogsRepository.searchBlogByIdDelete(req.params.id);
    if (!foundBlogDelete) {
        res.sendStatus(404);
        return;
    }
